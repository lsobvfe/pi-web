...
export function AppShell() {
  ...
  }, [activeCwd, activeFileTabId, invalidateWorkspaceRestore, newSessionCwd, replaceUrl, selectedSession, restoreWorkspaceContext]);
  ...
  }, [activeCwd, activeFileTabId, invalidateWorkspaceRestore, replaceUrl, isMobile, newSessionCwd, selectedSession]);
  ...
  const handleAskInNewChat = useCallback(async (
    ...
    const result = await sendAgentCommand<{ newSessionId?: string }>(piWebFetch, sourceSessionId, {
      type: "fork_branch",
  ...
  }, [handleSessionForked, piWebFetch, translate]);
